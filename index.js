customScript = {
    ...
    socials: {
        'facebook' : {
            ...
            "viewBox" : "0 0 512 512",
            'class' : "bg-white text-purple-600 w-8 h-8 rounded-full mr-3"
        },
        'twitter' : {
            "name" : "Twitter",
            ...
            "viewBox" : "0 0 512 512",
            'class' : "bg-purple-600 text-white w-8 h-8 rounded-full p-1 mr-3"
        },
        'instagram' : {
            "name" : "Instagram",
        ...
        'linkedin' : {
            ...
            "viewBox" : "0 0 448 512",
            'class' : "bg-purple-600 text-white w-8 h-8 rounded-full p-0.5 mr-3"
        },
        'wordpress' : {
            "name" : "Wordpress",
        ...
        'github' : {
            ...
            "viewBox" : "0 0 496 512",
            'class' : "bg-white text-purple-600 w-8 h-8 rounded-full"
        },
    },
    ...
    createSocialIcon: function(obj){
        ...
        node.setAttribute("data-prefix", "fab");
        node.setAttribute("data-icon", obj.name.toLowerCase());
        node.setAttribute("class", obj.class);
        node.setAttribute("role", "img");
        node.setAttribute("xmlns", "http://www.w3.org/2000/svg");
        node.setAttribute("viewBox", obj.viewBox);
        node.onclick = function(){
            window.open(obj.url);
        };
        childNode = document.createElementNS('http://www.w3.org/2000/svg', "path");
        childNode.setAttribute("fill", "currentColor");
        childNode.setAttribute("d", obj.d);
